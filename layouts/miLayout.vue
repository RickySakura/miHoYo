<template>
  <div class="container">
    ...
    <div class="home">
      ...
      <div class="aside-scroll scroll-btn scroll-btn--dark">
...
/**
 * 
 * @param {number} speed slide滚动的速度，默认为0
 */
...
.home {
  ...
  height: 100%;
  position: sticky;
  background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABcAAAAXCAYAAADgKtSgAAAAAXNSR0IArs4c6QAAAFVJREFUSEtjfPn+238GJMDBxozMJZn949dfuB5GkOHiglyMJJtChIYhbPjHrz//83Oz0yZYRg3HlngYR4NlNFiIKFUgSkZTC9agGg0W7MEyWs1hCxcAF5pe5Ya82ZoAAAAASUVORK5CYII=") repeat center center/.23rem .23rem;
...
.scroll-btn__arrow {
  ...
  img {
    ...
    animation: scrollmove 1.4s ease-in-out .4s infinite;
  }
}
