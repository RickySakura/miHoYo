  ...
  <div class="container">
    ...
    <div class="home">
      ...
      <div class="aside-slogan" v-if="isRender">
        <img
          src="https://www.mihoyo.com/_nuxt/img/line.a3e37b6.png"
          alt="miHoYo_F"
          class="aside-slogan__line"
          style="display: none"
        />
        <img
...
.aside-slogan__line {
  ...
  width: 2.72rem;
  height: 5.28rem;
  background: url(https://www.mihoyo.com/_nuxt/img/line.a3e37b6.png) no-repeat center
    center/100% 100%;
}
...
.scroll-btn__mouse {
  ...
  background: url("data:image/svg+xml;base64,")
    no-repeat top center/0.18rem auto;
}
